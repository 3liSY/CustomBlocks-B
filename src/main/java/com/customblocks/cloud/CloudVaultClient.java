...
public final class CloudVaultClient {
    ...
    // Backups are LOCAL-ONLY (dropped 2026-07-23, TG9 §F). Cloud backup needed Cloudflare R2, which
    // requires a billing card the owner declined; the worker's category/note (KV) path stays free.
