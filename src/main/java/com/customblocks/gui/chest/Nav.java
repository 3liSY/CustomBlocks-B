...
public final class Nav {
    ...
    public enum Dest { MAIN, BLOCK_LIST, EDITOR, UNDO, REDO, HISTORY, MAGIC, MAGIC_EDIT, CONFIG, TEXTURE_SIZE, RETEXTURE_CONFIRM, RECOLOR_CONFIRM, HEX_RECOLOR_CONFIRM, HEX_COLORS, CUSTOM_COLOR, DIAG, SEARCH, HELP, OMNI }
