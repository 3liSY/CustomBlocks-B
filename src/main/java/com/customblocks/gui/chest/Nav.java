...
public final class Nav {
     ...
     * BLOCK_LIST / BULK_HUB / BULK_SELECT / BULK_ACTION / BULK_CONFIRM were removed with their menus
     * (Group 07 §G07-3) — the Bulk Workbench Screen is not a chest menu and never enters this router.
     */
    public enum Dest { MAIN, EDITOR, REID, UNDO, REDO, HISTORY, MAGIC, MAGIC_EDIT, CONFIG, TEXTURE_SIZE, RETEXTURE_CONFIRM, RECOLOR_CONFIRM, HEX_RECOLOR_CONFIRM, HEX_COLORS, CUSTOM_COLOR, DIAG, SEARCH, HELP, OMNI, SHAPE_EDITOR, FACE_EDITOR, BACKUP_LIST, BACKUP_CONFIRM, CONFIG_CONFIRM, TRASH_LIST, TRASH_ENTRY, BROKEN_LIST, BROKEN_CONFIRM, SAFETY, BGSTUDIO, COLOR_VARIANTS, COLORS, PALETTE_LIST, GRADIENT_PICKER, COLOR_PICK, CATEGORY_LIST, CATEGORY_BROWSE, CATEGORY_BLOCK, CATEGORY_EDIT, CATEGORY_DELETE_CONFIRM, EXPORT_DASHBOARD, ARABIC, ARABIC_LIST, ARABIC_GROUP, ARABIC_CHOICE, ARABIC_COLOR, ANIM_LIST, AUDIT, REPORT, PARTICLES, DEBUG_LOG, NOTES, STEPPER, SUBCFG }
