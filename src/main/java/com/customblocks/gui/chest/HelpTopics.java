...
public final class HelpTopics {
    ...
    public static final List<Category> CATEGORIES = List.of(
            ...
            new Category("Organize", Items.BOOKSHELF, "Categories, lore, locks, favorites", List.of(
                    ...
                    new Topic("category", "/cb category", "Category tools (rename, combine, delete, color, icon…)"),
                    new Topic("category edit", "/cb category edit <category>", "Open the category editor GUI"),
                    new Topic("category rename", "/cb category rename <old> into <new>", "Rename a category"),
                    new Topic("category combine", "/cb category combine <a> into <b>", "Fold one category into another"),
                    new Topic("category delete", "/cb category delete <category>", "Drop a category (asks before deleting blocks)"),
                    new Topic("category open", "/cb category open <category>", "Open the Category Hub on one category"),
                    new Topic("category color", "/cb category color <color> <category>", "Tint the category name"),
                    new Topic("category filter", "/cb category filter [order] <category>", "List a category's blocks in order"),
                    new Topic("category info", "/cb category info [list] <category>", "Show a category's details"),
            ...
            new Category("Sharing", Items.ENDER_CHEST, "Export, import and integrations", List.of(
                    ...
                    new Topic("importfolder", "/cb importfolder", "Turn a folder of pictures into blocks"),
