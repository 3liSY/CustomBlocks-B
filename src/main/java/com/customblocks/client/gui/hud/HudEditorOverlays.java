...
public final class HudEditorOverlays {
    ...
    public static void drawHelp(DrawContext ctx, TextRenderer tr, int screenW, int screenH) {
        ...
        ctx.fill(x, y, x + pw, y + ph, com.customblocks.client.gui.CbTheme.PANEL_BG);
        ctx.drawTextWithShadow(tr, com.customblocks.client.gui.CbTheme.title("HUD Editor", "Shortcuts"), x + 10, y + 8, 0xFFFFFFFF);
    ...
    public static void drawConfirm(DrawContext ctx, TextRenderer tr, int screenW, int screenH) {
        ...
        ctx.fill(cx - pw / 2, cy - ph / 2, cx + pw / 2, cy + ph / 2, com.customblocks.client.gui.CbTheme.DIALOG_BG);
