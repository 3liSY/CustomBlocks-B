...
public record SlotData(int index, String customId, String displayName,
    ...
    /** Normalize a null/blank shape to the default so callers never see null. */
    public SlotData {
    ...
    public SlotData(int index, String customId, String displayName,
        ...
        this(index, customId, displayName, glow, hardness, soundType, noCollision, category, DEFAULT_SHAPE);
    }

    /** Back-compat: a new block starts with no glow, default hardness/sound, solid, uncategorized, full. */
    public SlotData(int index, String customId, String displayName) {
        this(index, customId, displayName, 0, DEFAULT_HARDNESS, DEFAULT_SOUND, false, DEFAULT_CATEGORY, DEFAULT_SHAPE);
    }
    ...
    public SlotData(int index, String customId, String displayName, int glow) {
        this(index, customId, displayName, glow, DEFAULT_HARDNESS, DEFAULT_SOUND, false, DEFAULT_CATEGORY, DEFAULT_SHAPE);
    }
    ...
    public SlotData update(String newCustomId, String newDisplayName) {
        return new SlotData(index, newCustomId, newDisplayName, glow, hardness, soundType, noCollision, category, shape);
    }

    public SlotData withCustomId(String newCustomId) {
        return new SlotData(index, newCustomId, displayName, glow, hardness, soundType, noCollision, category, shape);
    }

    public SlotData withDisplayName(String newDisplayName) {
        return new SlotData(index, customId, newDisplayName, glow, hardness, soundType, noCollision, category, shape);
    }

    /** Return a copy with a new light level, clamped to the valid 0..15 range. */
    public SlotData withGlow(int newGlow) {
        return new SlotData(index, customId, displayName, Math.max(0, Math.min(15, newGlow)), hardness, soundType, noCollision, category, shape);
    }
    ...
    public SlotData withHardness(float newHardness) {
        return new SlotData(index, customId, displayName, glow, newHardness, soundType, noCollision, category, shape);
    }

    /** Return a copy with a new sound group key (see SlotBlock.getSoundGroup). */
    public SlotData withSoundType(String newSoundType) {
        return new SlotData(index, customId, displayName, glow, hardness, newSoundType, noCollision, category, shape);
    }
    ...
    public SlotData withNoCollision(boolean newNoCollision) {
        return new SlotData(index, customId, displayName, glow, hardness, soundType, newNoCollision, category, shape);
    }
    ...
    public SlotData withCategory(String newCategory) {
        return new SlotData(index, customId, displayName, glow, hardness, soundType, noCollision,
                newCategory == null ? DEFAULT_CATEGORY : newCategory, shape);
    }
    ...
    public SlotData withShape(String newShape) {
        return new SlotData(index, customId, displayName, glow, hardness, soundType, noCollision, category,
                newShape == null || newShape.isBlank() ? DEFAULT_SHAPE : newShape);
    }
}
