...
## 🔗 Unified-scheme IDs (G##-n)

> Crosswalk to `docs/Information/ID_MAP.md` §G01. The full pass/fail checklist for each item is written
> here **after it is implemented** (Golden Rule). Until then, status only.

| Unified ID | Item                 | Status           | Test        |
| ---------- | -------------------- | ---------------- | ----------- |
| G01-1      | Legacy feature audit | ✅ audit complete | this report |
