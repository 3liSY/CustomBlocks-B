...
5. **Docs location → `docs/`.** Group specs live in `docs/groups/`, testing guides in `docs/testing/`, reference files in `docs/Information/`. The Engineering Bible stays capped at Phase 16.
